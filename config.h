...
static const char *fonts[]          = { "SauceCodePro NFP Medium:size=11", "SauceCodePro NFP Medium:pixelsize=11:antialias=true:autohint=true"};
static const char dmenufont[]       = "SauceCodePro NFP Medium:size=11";
